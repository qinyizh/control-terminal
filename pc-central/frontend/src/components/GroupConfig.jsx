  ...
  const handleSelectionChange = (value, index) => {
    ...
    const newConfigs = {
      ...
      [`config${index}`]: {
        ...
        MsCharacterIndex: group.configs[`config${index}`]?.MsCharacterIndex,
      ...
      <div className="config-section">
        ...
        <div className="player-name-container">
          <Input
            ...
            value={group.configs[`config${index}`]?.MsPlayerName || ''}
            onChange={e => handleConfigChange(index, 'MsPlayerName', e.target.value)}
            placeholder="玩家"
          />
          <CloudServerOutlined 
            ...
            <div className="config-form-items">
              <Form layout="horizontal" className="config-form">
                ...
                <Form.Item label="角色类型">
                  <Select
                    value={group.configs[`config${index}`]?.MsCharacterIndex}
                    onChange={value => handleConfigChange(index, 'MsCharacterIndex', value)}
                  >
